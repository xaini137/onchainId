...
contract RestrictionMessages {
    ...
    uint8 public constant FAILURE_NON_WHITELIST = 2;
    uint8 public constant FAILURE_TIMELOCK = 3;
    uint8 public constant FAILURE_CONTRACT_PAUSED = 4;
    uint8 public constant NO_USER_TYPE = 1;
    string public constant SUCCESS_MESSAGE = "SUCCESS";
    string public constant FAILURE_NON_WHITELIST_MESSAGE =
        "The transfer was restricted due to white list configuration.";
    string public constant FAILURE_TIMELOCK_MESSAGE =
        "The transfer was restricted due to timelocked tokens.";
    string public constant FAILURE_CONTRACT_PAUSED_MESSAGE =
        "The transfer was restricted due to the contract being paused.";
    string public constant UNKNOWN_ERROR = "Unknown Error Code";
    string public constant NO_USER_TYPE_ASSIGNED =
 ...
 */
contract TransferRestrictions is
    IERC1404,
    RestrictionMessages,
    IERC1404Success
{
    ...
    */
    constructor(address _validators)  {
        require(
            ...
            "0x0 is not a valid _validators address"
        );
    ...
    */
    function messageForTransferRestriction(
        ...
        if (restrictionCode == NO_USER_TYPE) {
            return NO_USER_TYPE_ASSIGNED;
        }
    ...
    function getSuccessCode() external pure returns (uint256) {
        return SUCCESS_CODE;
    }
}
